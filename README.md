...
## Objective
The primary objective of the CryptoClustering project is to use unsupervised learning techniques, particularly K-means clustering, to analyse and predict the behaviour of cryptocurrencies based on their 24-hour and 7-day price changes. This project aims to determine if clustering can reveal meaningful patterns and insights in the cryptocurrency market data.

## Steps Involved

### 1. Data Preparation
- **Loading Data:** The cryptocurrency market data is loaded from a CSV file into a Pandas DataFrame.
- **Data Normalisation:** The data is normalised using the `StandardScaler` module from `scikit-learn` to ensure that all features contribute equally to the clustering algorithm.

### 2. Exploratory Data Analysis (EDA)
- **Summary Statistics:** Compute summary statistics to understand the data distribution.
- **Data Visualisation:** Visualise the data to identify any initial patterns or anomalies.
...
- **Initial Clustering:** Apply K-means clustering on the normalised data using the optimal number of clusters identified.
- **Prediction:** Predict the clusters for each cryptocurrency.
- **Visualisation:** Create scatter plots to visualise the clusters with respect to 24-hour and 7-day price changes.
...
- **PCA Data Visualisation:** Create a new DataFrame with the PCA-transformed data and visualise the clusters.
...
- **Visualisation:** Visualise the clusters in the reduced feature space.
...
- **Impact Analysis:** Analyse the impact of using fewer features on the clustering results and interpret the findings.
...
- **scikit-learn:** For data normalisation, K-means clustering, and PCA.
- **hvPlot:** For creating interactive visualisations.

This project provides a comprehensive approach to clustering and analysing cryptocurrency market data, leveraging unsupervised learning techniques to uncover hidden patterns and insights.
